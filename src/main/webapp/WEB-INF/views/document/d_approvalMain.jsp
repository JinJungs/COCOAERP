		...
		<div id="content" class="p-4 p-md-5 pt-5">
			...
			<c:forEach var="list" items="${list}">
				<div class="row text-center">
					<div class="col-2">${list.seq }</div>
					<div class="col-2 d-none d-sm-block">${list.temp_name }</div>
					<div class="col-4">${list.title }</div>
					<div class="col-3 col-sm-2">${list.write_date }</div>
					<div class="col-3 col-sm-2">${list.final_date }</div>
				</div>
			</c:forEach>
			<!-- 리스트 출력 부분 -->
