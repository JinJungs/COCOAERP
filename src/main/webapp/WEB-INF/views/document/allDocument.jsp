					...
					<div id="tab-2" class="tab-content">
						<div class=notice-list id=myboard>
							<c:forEach var="list" items="${list }">
								<div class="row p-3" style="border-bottom: 1px solid #c9c9c9">
									<div class="col-2 p-2 text-center textBox">${list.seq }</div>
									<div class="col-3 p-2 textBox">${list.title }</div>
									<div class="col-3 p-2 text-center textBox">${list.write_date }</div>
									<div class="col-3 p-2 text-center textBox">${list.emp_name }</div>
									<div class="col-2 p-2 text-center textBox">${list.detailStatus }</div>
								</div>
							</c:forEach>
						</div>
					</div>
