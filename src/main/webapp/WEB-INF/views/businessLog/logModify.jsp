		...
		<div id="content" class="p-4 p-md-5 pt-5">
			<h2 class="mb-4 board_title">업무일지 수정</h2>
						...
						<div class="row" style="border: none;">
							<div class="col date_box">
								<b>시작일 :</b> <input type="date" class="date ml-1 mr-1"
									name=startDate value="${lr.report_start}">
							</div>
							<div class="col date_box">
				...
				<div class="row" id="contents_box">
					<textarea class=" col-xs-12" id="contents" name="contents"
						onclick="contents_box()">${lr.contents}</textarea>
				</div>
			<!--첨부파일  -->
			<div class="row">
			...
			<div class="row">
				...
				<div class="button_box col-sm-5">
					...
					<button type="submit" class="btn btn-primary" onclick="fn_modify()">수정</button>
