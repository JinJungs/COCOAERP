...
<body>
   ...
   <script >
            ...
            success: function (data){
               ...
               for(let j=0; j<9; j++){
                  if(!data[j][0].mid_name){ //mid_name이 없는 경우 - 조직도, 버그리포팅
                     html += "<li><a href='javascript:side_findLocation("+data[j][0].code+");'>"+data[j][0].menu_name+"</a></li>";
      ...
      function side_findLocation(code){
         console.log("코드 : " +code);
         // 1. 업무일지
         if(code==1){
         ...
         // 9. 버그리포트
            ...
            /*if(type=='Album'){ // code =34
               location.href = "/noBoard/notificationBoardList.no?menu_seq="+code-30;
            }
            location.href="#";*/
         }
      }
