(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static01_00","0","229","110","32",null,null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("0");
            obj.set_text("상태");
            obj.set_cssclass("sta_cm_box01R");
            this.div_detail.addChild(obj.name, obj);

            obj = new Static("Static01_00_00","0","273","110","166",null,null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("1");
            obj.set_text("설명");
            obj.set_cssclass("sta_cm_box01R");
            this.div_detail.addChild(obj.name, obj);

            obj = new Static("Static01_00_01","0","78","110","32",null,null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("4");
            obj.set_text("대분류");
            obj.set_cssclass("sta_cm_box01R");
            this.div_detail.addChild(obj.name, obj);

            obj = new Static("Static28_00","110","78","240","32",null,null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("5");
            obj.set_cssclass("sta_cm_box02L");
            this.div_detail.addChild(obj.name, obj);

            obj = new Edit("Edit07","120","82","140","24",null,null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("6");
            obj.set_readonly("true");
            this.div_detail.addChild(obj.name, obj);

            obj = new Static("Static28_00_00","110","108","240","32",null,null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("7");
            obj.set_cssclass("sta_cm_box02L");
            this.div_detail.addChild(obj.name, obj);

            obj = new Edit("Edit07_00","120","112","140","24",null,null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("8");
            obj.set_readonly("true");
            this.div_detail.addChild(obj.name, obj);

            obj = new Static("Static01_00_01_00","0","108","110","32",null,null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("9");
            obj.set_text("중분류");
            obj.set_cssclass("sta_cm_box01R");
            this.div_detail.addChild(obj.name, obj);

            obj = new Static("Static28_00_00_00","110","139","240","32",null,null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("10");
            obj.set_cssclass("sta_cm_box02L");
            this.div_detail.addChild(obj.name, obj);

            obj = new Edit("Edit07_00_00","120","142","140","24",null,null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("11");
            obj.set_readonly("true");
            this.div_detail.addChild(obj.name, obj);

            obj = new Static("Static01_00_01_00_00","0","139","110","32",null,null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("12");
            obj.set_text("소분류");
            obj.set_cssclass("sta_cm_box01R");
            this.div_detail.addChild(obj.name, obj);

            obj = new Static("Static28_00_00_00_00","110","272","240","167",null,null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("13");
            obj.set_cssclass("sta_cm_box02L");
            this.div_detail.addChild(obj.name, obj);

            obj = new TextArea("TextArea00","120","279","220","150",null,null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("2");
            obj.set_scrolltype("vertical");
            this.div_detail.addChild(obj.name, obj);

            obj = new Static("Static28_00_00_00_01","111","229","240","32",null,null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("14");
            obj.set_cssclass("sta_cm_box02L");
            this.div_detail.addChild(obj.name, obj);

            obj = new Radio("rds_status","123","232","185","27",null,null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("3");
            ...
            obj = new Button("btn_search","803","70","70","30",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_text("검색");
            this.addChild(obj.name, obj);

            obj = new Static("Static09_00","53.03%","73","7.71%","25",null,null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_text("이름");
            obj.set_cssclass("sta_cm_text12R");
            this.addChild(obj.name, obj);

            obj = new Edit("Edit00","61.93%","73","10.92%","25",null,null,null,null,null,null,this);
            obj.set_taborder("12");
            this.addChild(obj.name, obj);
