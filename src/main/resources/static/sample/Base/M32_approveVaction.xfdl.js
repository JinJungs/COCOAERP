    ...
    return function()
    {
        ...
        this.btnAdd_onclick = function(obj,e)
        {
        	this.transaction(
        			...
        			"", // 5. strArgument 화면에서 서버로 보내는 변수값 (구분자는 띄어쓰기로' ')
        			"fn_callback2" // 6. strCallbackFunc
        		);
        };
